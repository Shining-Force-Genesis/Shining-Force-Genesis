...
func clean_battle_target_array() -> void:
	for i in Singleton_CommonVariables.battle__target_array.size():
		for j in Singleton_CommonVariables.battle__target_array[i].size():
			if Singleton_CommonVariables.battle__target_array[i][j].actor_type != "na":
				if is_actor_type_targetable(Singleton_CommonVariables.battle__target_array[i][j].actor_type):
					pass
				else:
					Singleton_CommonVariables.battle__target_array[i][j].actor_type = "na"
